...
**Q1: 什么是奖励模型 (Reward Model)？它在 RLHF 中扮演什么角色？**
...
**Q2: Bradley-Terry 模型的核心假设是什么？其训练损失函数是什么形式？**
...
**Q3: PRM 和 ORM 的核心区别是什么？各自适用于什么场景？**
...
**Q4: 什么是 Best-of-N (BoN) 采样？它与 RL 训练有什么区别？**
...
**Q5: 什么是奖励欺骗 (Reward Hacking)？请举 2-3 个具体例子。**
...
**Q7: 如何用 RM 集成 (ensemble) 缓解奖励欺骗？不同聚合策略有何区别？**
...
**Q8: 长度偏差 (length bias) 的成因是什么？如何在数据层面和推理层面缓解？**
...
**Q9: 迭代重训练 (iterative re-training) 如何缓解分布偏移 (distribution shift)？**
...
**Q10: LLM-as-Judge 有哪些主要偏差？如何系统性地缓解？**
...
**Q11: RewardBench 是什么？它评估 RM 的哪些能力维度？**
...
**Q12: 从理论角度分析，为什么 KL 约束在 RM 不完美时是必要的？**
...
**Q13: 设计一个完整的迭代 RLHF 系统，描述其架构和关键决策点。**
...
**Q14: 对比 PRM 的 Monte Carlo 估计方法与直接人工标注，分析各自的偏差-方差权衡。**
...
**Q15: 如何设计一个对 reward hacking 鲁棒的评估框架？**
...
**Q16: 讨论 LLM-as-Judge 的自我偏好 (self-preference) 偏差对 benchmark 排行榜的影响。**
...
**Q17: 为什么说 "RM 的泛化能力是 RLHF 最关键的瓶颈"？**
...
**Q18: 从信息论角度，为什么 pairwise 比 pointwise 更高效？**
...
**Q19: 比较 DPO 和 RLHF 在处理 reward hacking 上的异同。**
...
**Q20: 如果你来设计下一代 RM，你认为最重要的三个改进方向是什么？**
