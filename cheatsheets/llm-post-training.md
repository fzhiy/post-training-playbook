...
- **2015-06 · GAE** — Schulman et al., ICLR 2016. [arXiv:1506.02438](https://arxiv.org/abs/1506.02438) — 提出广义优势估计（GAE），用指数加权的 TD(λ) 多步回报替代单步 TD，通过 λ 连续调节 bias-variance 权衡，是 PPO/RLHF 中优势估计的标准基础。
