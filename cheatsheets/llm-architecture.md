...
- **2022-03 · Chinchilla** — Hoffmann et al., NeurIPS 2022. [arXiv:2203.15556](https://arxiv.org/abs/2203.15556) — 计算最优缩放律:固定算力下参数与训练 token 应近 1:1 同比增长,纠正"只堆参数"的偏见,重定义预训练配比。
